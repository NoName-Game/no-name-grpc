...
func (x *Titan) Reset() {
	*x = Titan{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_titan_proto_msgTypes[0]
...
func (*Titan) Descriptor() ([]byte, []int) {
	return file_rpc_titan_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetTitanByIDRequest) Reset() {
	*x = GetTitanByIDRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_titan_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetTitanByIDRequest) Descriptor() ([]byte, []int) {
	return file_rpc_titan_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetTitanByIDResponse) Reset() {
	*x = GetTitanByIDResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_titan_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetTitanByIDResponse) Descriptor() ([]byte, []int) {
	return file_rpc_titan_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetTitanByPlanetIDRequest) Reset() {
	*x = GetTitanByPlanetIDRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_titan_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetTitanByPlanetIDRequest) Descriptor() ([]byte, []int) {
	return file_rpc_titan_proto_rawDescGZIP(), []int{3}
}
...
func (x *GetTitanByPlanetIDResponse) Reset() {
	*x = GetTitanByPlanetIDResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_titan_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetTitanByPlanetIDResponse) Descriptor() ([]byte, []int) {
	return file_rpc_titan_proto_rawDescGZIP(), []int{4}
}
...
func (x *GetTitanByNameRequest) Reset() {
	*x = GetTitanByNameRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_titan_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetTitanByNameRequest) Descriptor() ([]byte, []int) {
	return file_rpc_titan_proto_rawDescGZIP(), []int{5}
}
...
func (x *GetTitanByNameResponse) Reset() {
	*x = GetTitanByNameResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_titan_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetTitanByNameResponse) Descriptor() ([]byte, []int) {
	return file_rpc_titan_proto_rawDescGZIP(), []int{6}
}
...
func (x *HitTitanRequest) Reset() {
	*x = HitTitanRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_titan_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HitTitanRequest) Descriptor() ([]byte, []int) {
	return file_rpc_titan_proto_rawDescGZIP(), []int{7}
}
...
func (x *HitTitanResponse) Reset() {
	*x = HitTitanResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_titan_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HitTitanResponse) Descriptor() ([]byte, []int) {
	return file_rpc_titan_proto_rawDescGZIP(), []int{8}
}
...
func (x *TitanDiscoveredRequest) Reset() {
	*x = TitanDiscoveredRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_titan_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TitanDiscoveredRequest) Descriptor() ([]byte, []int) {
	return file_rpc_titan_proto_rawDescGZIP(), []int{9}
}
...
func (x *TitanDiscoveredResponse) Reset() {
	*x = TitanDiscoveredResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_titan_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TitanDiscoveredResponse) Descriptor() ([]byte, []int) {
	return file_rpc_titan_proto_rawDescGZIP(), []int{10}
}
...
var File_rpc_titan_proto protoreflect.FileDescriptor

var file_rpc_titan_proto_rawDesc = []byte{
	0x0a, 0x0f, 0x72, 0x70, 0x63, 0x2f, 0x74, 0x69, 0x74, 0x61, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x12, 0x05, 0x74, 0x69, 0x74, 0x61, 0x6e, 0x22, 0x7f, 0x0a, 0x05, 0x54, 0x69, 0x74, 0x61,
	...
	0x04, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x50, 0x6c, 0x61, 0x6e, 0x65, 0x74, 0x49,
	0x44, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x50, 0x6c, 0x61, 0x6e, 0x65, 0x74, 0x49,
	0x44, 0x12, 0x18, 0x0a, 0x07, 0x4c, 0x69, 0x66, 0x65, 0x4d, 0x61, 0x78, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x07, 0x4c, 0x69, 0x66, 0x65, 0x4d, 0x61, 0x78, 0x12, 0x1c, 0x0a, 0x09, 0x4c,
	0x69, 0x66, 0x65, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x09, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09,
	0x4c, 0x69, 0x66, 0x65, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0x25, 0x0a, 0x13, 0x47, 0x65, 0x74,
	...
	0x22, 0x3a, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x54, 0x69, 0x74, 0x61, 0x6e, 0x42, 0x79, 0x49, 0x44,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x22, 0x0a, 0x05, 0x54, 0x69, 0x74, 0x61,
	0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x74, 0x69, 0x74, 0x61, 0x6e, 0x2e,
	0x54, 0x69, 0x74, 0x61, 0x6e, 0x52, 0x05, 0x54, 0x69, 0x74, 0x61, 0x6e, 0x22, 0x37, 0x0a, 0x19,
	...
	,
}

var (
	file_rpc_titan_proto_rawDescOnce sync.Once
	file_rpc_titan_proto_rawDescData = file_rpc_titan_proto_rawDesc
)

func file_rpc_titan_proto_rawDescGZIP() []byte {
	file_rpc_titan_proto_rawDescOnce.Do(func() {
		file_rpc_titan_proto_rawDescData = protoimpl.X.CompressGZIP(file_rpc_titan_proto_rawDescData)
	})
	return file_rpc_titan_proto_rawDescData
}

var file_rpc_titan_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_rpc_titan_proto_goTypes = []interface{}{
...
var file_rpc_titan_proto_depIdxs = []int32{
...
func init() { file_rpc_titan_proto_init() }
func file_rpc_titan_proto_init() {
	if File_rpc_titan_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_rpc_titan_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Titan); i {
			case 0:
				return &v.state
			case 1:
		...
		file_rpc_titan_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpc_titan_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpc_titan_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpc_titan_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpc_titan_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpc_titan_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpc_titan_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpc_titan_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpc_titan_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpc_titan_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_rpc_titan_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_rpc_titan_proto_goTypes,
		DependencyIndexes: file_rpc_titan_proto_depIdxs,
		MessageInfos:      file_rpc_titan_proto_msgTypes,
	}.Build()
	File_rpc_titan_proto = out.File
	file_rpc_titan_proto_rawDesc = nil
	file_rpc_titan_proto_goTypes = nil
	file_rpc_titan_proto_depIdxs = nil
}
