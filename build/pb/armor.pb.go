...
func (x *Armor) Reset() {
	*x = Armor{}
	if protoimpl.UnsafeEnabled {
		mi := &file_armor_proto_msgTypes[0]
...
func (*Armor) Descriptor() ([]byte, []int) {
	return file_armor_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetArmorByIDRequest) Reset() {
	*x = GetArmorByIDRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_armor_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetArmorByIDRequest) Descriptor() ([]byte, []int) {
	return file_armor_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetArmorByIDResponse) Reset() {
	*x = GetArmorByIDResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_armor_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetArmorByIDResponse) Descriptor() ([]byte, []int) {
	return file_armor_proto_rawDescGZIP(), []int{2}
}
...
func (x *FindArmorByNameRequest) Reset() {
	*x = FindArmorByNameRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_armor_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FindArmorByNameRequest) Descriptor() ([]byte, []int) {
	return file_armor_proto_rawDescGZIP(), []int{3}
}
...
func (x *FindArmorByNameResponse) Reset() {
	*x = FindArmorByNameResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_armor_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FindArmorByNameResponse) Descriptor() ([]byte, []int) {
	return file_armor_proto_rawDescGZIP(), []int{4}
}
...
func (x *UpdateArmorRequest) Reset() {
	*x = UpdateArmorRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_armor_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdateArmorRequest) Descriptor() ([]byte, []int) {
	return file_armor_proto_rawDescGZIP(), []int{5}
}
...
func (x *UpdateArmorResponse) Reset() {
	*x = UpdateArmorResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_armor_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdateArmorResponse) Descriptor() ([]byte, []int) {
	return file_armor_proto_rawDescGZIP(), []int{6}
}
...
func (x *GetPlayerArmorsRequest) Reset() {
	*x = GetPlayerArmorsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_armor_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetPlayerArmorsRequest) Descriptor() ([]byte, []int) {
	return file_armor_proto_rawDescGZIP(), []int{7}
}
...
func (x *GetPlayerArmorsResponse) Reset() {
	*x = GetPlayerArmorsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_armor_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetPlayerArmorsResponse) Descriptor() ([]byte, []int) {
	return file_armor_proto_rawDescGZIP(), []int{8}
}
...
func (x *GetPlayerArmorsEquippedRequest) Reset() {
	*x = GetPlayerArmorsEquippedRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_armor_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetPlayerArmorsEquippedRequest) Descriptor() ([]byte, []int) {
	return file_armor_proto_rawDescGZIP(), []int{9}
}
...
func (x *GetPlayerArmorsEquippedResponse) Reset() {
	*x = GetPlayerArmorsEquippedResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_armor_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetPlayerArmorsEquippedResponse) Descriptor() ([]byte, []int) {
	return file_armor_proto_rawDescGZIP(), []int{10}
}
...
var File_armor_proto protoreflect.FileDescriptor

var file_armor_proto_rawDesc = []byte{
	,
	...
	0x65, 0x72, 0x49, 0x44, 0x22, 0x3f, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x50, 0x6c, 0x61, 0x79, 0x65,
	0x72, 0x41, 0x72, 0x6d, 0x6f, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x24, 0x0a, 0x06, 0x41, 0x72, 0x6d, 0x6f, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x0c, 0x2e, 0x61, 0x72, 0x6d, 0x6f, 0x72, 0x2e, 0x41, 0x72, 0x6d, 0x6f, 0x72, 0x52, 0x06, 0x41,
	0x72, 0x6d, 0x6f, 0x72, 0x73, 0x22, 0x3c, 0x0a, 0x1e, 0x47, 0x65, 0x74, 0x50, 0x6c, 0x61, 0x79,
	...
	0x72, 0x49, 0x44, 0x22, 0x47, 0x0a, 0x1f, 0x47, 0x65, 0x74, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72,
	0x41, 0x72, 0x6d, 0x6f, 0x72, 0x73, 0x45, 0x71, 0x75, 0x69, 0x70, 0x70, 0x65, 0x64, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x24, 0x0a, 0x06, 0x41, 0x72, 0x6d, 0x6f, 0x72, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x61, 0x72, 0x6d, 0x6f, 0x72, 0x2e, 0x41,
	0x72, 0x6d, 0x6f, 0x72, 0x52, 0x06, 0x41, 0x72, 0x6d, 0x6f, 0x72, 0x73, 0x42, 0x06, 0x5a, 0x04,
	0x2e, 0x3b, 0x70, 0x62, 0x50, 0x00, 0x50, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_armor_proto_rawDescOnce sync.Once
	file_armor_proto_rawDescData = file_armor_proto_rawDesc
)

func file_armor_proto_rawDescGZIP() []byte {
	file_armor_proto_rawDescOnce.Do(func() {
		file_armor_proto_rawDescData = protoimpl.X.CompressGZIP(file_armor_proto_rawDescData)
	})
	return file_armor_proto_rawDescData
}

var file_armor_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_armor_proto_goTypes = []interface{}{
...
var file_armor_proto_depIdxs = []int32{
...
func init() { file_armor_proto_init() }
func file_armor_proto_init() {
	if File_armor_proto != nil {
		return
	}
	file_rarity_proto_init()
	file_armor_category_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_armor_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Armor); i {
			case 0:
				return &v.state
			case 1:
		...
		file_armor_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_armor_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_armor_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_armor_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_armor_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_armor_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_armor_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_armor_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_armor_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_armor_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_armor_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_armor_proto_goTypes,
		DependencyIndexes: file_armor_proto_depIdxs,
		MessageInfos:      file_armor_proto_msgTypes,
	}.Build()
	File_armor_proto = out.File
	file_armor_proto_rawDesc = nil
	file_armor_proto_goTypes = nil
	file_armor_proto_depIdxs = nil
}
