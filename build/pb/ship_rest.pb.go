...
type StartPlayerRestResponse struct {
	...
	PlayEndTime *types.Timestamp `protobuf:"bytes,2,opt,name=PlayEndTime,proto3" json:"PlayEndTime,omitempty"`
}
...
func (m *StartPlayerRestResponse) GetPlayEndTime() *types.Timestamp {
	if m != nil {
		return m.PlayEndTime
	}
	return nil
}
...
var fileDescriptor_b27bef38eeb2c890 = []byte{
	...
	,
}
...
func (m *StartPlayerRestResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.PlayEndTime != nil {
		{
			size, err := m.PlayEndTime.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *StartPlayerRestResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PlayEndTime", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PlayEndTime == nil {
				m.PlayEndTime = &types.Timestamp{}
			}
			if err := m.PlayEndTime.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
