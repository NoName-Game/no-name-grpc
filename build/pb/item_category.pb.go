...
func (*ItemCategory) Descriptor() ([]byte, []int) {
	return fileDescriptor_c74879f1721eaf4e, []int{0}
}
...
func (*GetAllItemCategoriesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c74879f1721eaf4e, []int{1}
}
...
func (*GetAllItemCategoriesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c74879f1721eaf4e, []int{2}
}
...
func init() { proto.RegisterFile("proto/item_category.proto", fileDescriptor_c74879f1721eaf4e) }

var fileDescriptor_c74879f1721eaf4e = []byte{
	// 190 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x2c, 0x28, 0xca, 0x2f,
	0xc9, 0xd7, 0xcf, 0x2c, 0x49, 0xcd, 0x8d, 0x4f, 0x4e, 0x2c, 0x49, 0x4d, 0xcf, 0x2f, 0xaa, 0xd4,
	0x03, 0x8b, 0x09, 0xf1, 0xa2, 0x08, 0x2a, 0xb9, 0x71, 0xf1, 0x78, 0x96, 0xa4, 0xe6, 0x3a, 0x43,
	...
	0x0f, 0xc8, 0x6e, 0x0d, 0x42, 0xd3, 0xe2, 0x24, 0x74, 0xe2, 0x91, 0x1c, 0xe3, 0x85, 0x47, 0x72,
	0x8c, 0x0f, 0x1e, 0xc9, 0x31, 0x46, 0xb1, 0xe8, 0x59, 0x17, 0x24, 0x25, 0xb1, 0x81, 0x7d, 0x6d,
	0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xf7, 0xf2, 0x66, 0x2d, 0x12, 0x01, 0x00, 0x00,
}

func (m *ItemCategory) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *ItemCategory) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ItemCategory) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Slug) > 0 {
		i -= len(m.Slug)
		copy(dAtA[i:], m.Slug)
		i = encodeVarintItemCategory(dAtA, i, uint64(len(m.Slug)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintItemCategory(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0x12
	}
	if m.ID != 0 {
		i = encodeVarintItemCategory(dAtA, i, uint64(m.ID))
		i--
		dAtA[i] = 0x8
	}
...
func (m *GetAllItemCategoriesRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetAllItemCategoriesRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetAllItemCategoriesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GetAllItemCategoriesResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetAllItemCategoriesResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetAllItemCategoriesResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ItemCategories) > 0 {
		for iNdEx := len(m.ItemCategories) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ItemCategories[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
				i = encodeVarintItemCategory(dAtA, i, uint64(size))
			}
			i--
			dAtA[i] = 0xa
		}
...
func encodeVarintItemCategory(dAtA []byte, offset int, v uint64) int {
	offset -= sovItemCategory(v)
	base := offset
	for v >= 1<<7 {
...
func (m *ItemCategory) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ID != 0 {
		n += 1 + sovItemCategory(uint64(m.ID))
	}
	l = len(m.Name)
	if l > 0 {
		n += 1 + l + sovItemCategory(uint64(l))
	}
	l = len(m.Slug)
	if l > 0 {
		n += 1 + l + sovItemCategory(uint64(l))
...
func (m *GetAllItemCategoriesRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetAllItemCategoriesResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.ItemCategories) > 0 {
		for _, e := range m.ItemCategories {
			l = e.Size()
			n += 1 + l + sovItemCategory(uint64(l))
		}
	}
...
func sovItemCategory(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozItemCategory(x uint64) (n int) {
	return sovItemCategory(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *ItemCategory) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowItemCategory
			}
			if iNdEx >= l {
		...
		if wireType == 4 {
			return fmt.Errorf("proto: ItemCategory: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ItemCategory: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthItemCategory
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipItemCategory(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func (m *GetAllItemCategoriesRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetAllItemCategoriesRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetAllItemCategoriesRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *GetAllItemCategoriesResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetAllItemCategoriesResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetAllItemCategoriesResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ItemCategories", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ItemCategories = append(m.ItemCategories, &ItemCategory{})
			if err := m.ItemCategories[len(m.ItemCategories)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func skipItemCategory(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowItemCategory
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthItemCategory
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupItemCategory
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthItemCategory        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowItemCategory          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupItemCategory = fmt.Errorf("proto: unexpected end of group")
)
