...
func (m *PlanetSystem) GetDeviation() uint32 {
	if m != nil {
		return m.Deviation
	}
	return 0
...
var fileDescriptor_c30d9dd40dc88634 = []byte{
	...
	0x12, 0xac, 0x60, 0x83, 0x11, 0x02, 0x4e, 0x42, 0x27, 0x1e, 0xc9, 0x31, 0x5e, 0x78, 0x24, 0xc7,
	0xf8, 0xe0, 0x91, 0x1c, 0x63, 0x14, 0x8b, 0x9e, 0x75, 0x41, 0x52, 0x12, 0x1b, 0xd8, 0xa5, 0xc6,
	0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x10, 0x10, 0xdb, 0x5b, 0xc6, 0x00, 0x00, 0x00,
}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Deviation |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
