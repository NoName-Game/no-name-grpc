...
type GetBidInfoRequest_BidTypeEnum int32

const (
	GetBidInfoRequest_BUY  GetBidInfoRequest_BidTypeEnum = 0
	GetBidInfoRequest_SELL GetBidInfoRequest_BidTypeEnum = 1
)

var GetBidInfoRequest_BidTypeEnum_name = map[int32]string{
	0: "BUY",
	1: "SELL",
}

var GetBidInfoRequest_BidTypeEnum_value = map[string]int32{
	"BUY":  0,
	"SELL": 1,
}

func (x GetBidInfoRequest_BidTypeEnum) String() string {
	return proto.EnumName(GetBidInfoRequest_BidTypeEnum_name, int32(x))
}

func (GetBidInfoRequest_BidTypeEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9c011a1f72755af8, []int{7, 0}
}
...
type GetBidInfoRequest struct {
	...
	Type     GetBidInfoRequest_BidTypeEnum `protobuf:"varint,4,opt,name=Type,proto3,enum=action.GetBidInfoRequest_BidTypeEnum" json:"Type,omitempty"`
}
...
func (m *GetBidInfoRequest) GetType() GetBidInfoRequest_BidTypeEnum {
	if m != nil {
		return m.Type
	}
	return GetBidInfoRequest_BUY
}
...
func init() {
	...
	proto.RegisterEnum("action.GetBidInfoRequest_BidTypeEnum", GetBidInfoRequest_BidTypeEnum_name, GetBidInfoRequest_BidTypeEnum_value)
...
var fileDescriptor_9c011a1f72755af8 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= GetBidInfoRequest_BidTypeEnum(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
